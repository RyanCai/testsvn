...
<!-- 页面折叠布局 -->	
<div class="easyui-accordion" style="width:100%;height:650px;">
        <!-- 面板一 -->
		<div title="个人信息" iconCls="icon-ok" style="overflow:auto;padding:10px;">
			<h3 style="color:#0099FF;">个人基本信息</h3>
  ...
  <c:if test="${sysUser.usertype==1}">
    ...
    <td><input type="button" value="修改"  onclick="editUser()"></td>
		...
		<!-- 面板2 -->
		<div title="收货地址" iconCls="icon-reload" selected="true" style="padding:10px;">
			easyui help you build your web page easily
		</div>
		
		<!-- 面板3 -->
		<div title="个人账户" iconCls="icon-reload" selected="true" style="padding:10px;">
			easyui help you build your web page easily
		</div>
