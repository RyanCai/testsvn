...
<title>运营登录(20150425删除已经无用了)</title>
        ...
        <div class="rule-box">
            <div class="rule-list">
              ...
              <div class="reg-switch-box">
                  <form class="registerform" action="http://try.zhe.com/login" method="post">
                  <div class="J_login">
                      <ul class="login-ul">
                          <li class="input_box">
                          ...
                          <li class="input_box">
                              ...
                              <input type="password" value="" name="password" class="inputxt big_input" datatype="*6-16"nullmsg="请填写密码" errormsg="密码范围在6~16位之间！"  placeholder="请输入密码" autocomplete="off" />
                          </li>
              ...
              <div class="aside-right-new">
                 <div class="col_l"><a class="" href="findpass.htm" tppabs="http://try.zhe.com/findpass"><span>忘记密码？</span></a>
                  <span>没有帐号</span>
                  <a class="" href="register.htm" tppabs="http://try.zhe.com/register"><span>注册</span></a></div>
                  <div class="other-way">
                  	<span>快捷方式登录：</span>
