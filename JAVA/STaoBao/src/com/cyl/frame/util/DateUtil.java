/*
 * @describe 
 * @fileName com.cttsp.frame.util.DateUtil
 ...
 * @see com.cttsp.frame.util.DateUtil
 * 
 */
public final class DateUtil {
//	private static ILogger log = (ILogger) LogFactory.getDefaultLogger(DateUtil.class);

	/**
	 * SimpleDateFormat日期+时间格式yyyy-MM-dd HH:mm:ss
	 */
	public static SimpleDateFormat SDF_DATETIME = new SimpleDateFormat(GlobalConstants.PATTERN_DATE_TIME);
	/**
	 * SimpleDateFormat日期格式yyyy-MM-dd
	 */
	public static SimpleDateFormat SDF_DATE = new SimpleDateFormat(GlobalConstants.PATTERN_DATE);
	 ...
	 * @param dateStr
	 * @return
	 * @see com.cttsp.frame.util.DateUtil#parse
	 */
...
//			log.error("字符串为空：dateStr=" + dateStr);
	 ...
	 * @param date
	 * @return
	 * @see com.cttsp.frame.util.DateUtil#format
	 */
...
//			log.error("Date参数为空：date=" + date);
	 ...
	 * @param dateStr
	 * @return
	 * @see com.cttsp.frame.util.DateUtil#parseToTimestamp
	 */
	 ...
	 * @param birthDate
	 * @return
	 * @see com.cttsp.frame.util.DateUtil#getAgeByDate
	 */
	 ...
	 * @return
	 * @see com.cttsp.frame.util.DateUtil#getWeekByDate
	 */
	 ...
	 * @param birthDateStr
	 * @return
	 * @see com.cttsp.frame.util.DateUtil#getAgeByDateStr
	 */
	 ...
	 * @param dayNumber
	 * @return
	 * @see com.cttsp.frame.util.DateUtil#getBeforeOrAfterDateByDayNumber
	 */
	 ...
	 * @param monthNumber
	 * @return
	 * @see com.cttsp.frame.util.DateUtil#getBeforeOrAfterDateByMonthNumber
	 */
	 ...
	 *            比较类型 1:< , 2:> , 3: <= , 4: >= , 5: ==
	 * @return
	 * @see com.cttsp.frame.util.DateUtil#compareDateOrTime
	 */
	 ...
	 * @return
	 * @see com.cttsp.web.costanalysis.monotherfee.action.MonOthFeeManagerAction#getLastMonDay
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println(calculateTime(new Date() , DateUtil.parse("2014-09-03 00:00:00")));
	}
